...
1. What is the purpose of using _sessions_?
    ...
    - To persist data through multiple visits. It's helpful in saving settings like theme's so that the user doesn't have to select it everytime they log in

1. What does bcrypt do to help us store passwords in a secure manner.

    - bcrypt hashes passwords and helps us not store them as plain text

1. What does bcrypt do to slow down attackers?

    - by hasing to a number of the nth degree, it makes it so that pw un-hashing is way slower.
